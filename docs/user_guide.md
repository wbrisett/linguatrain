...
> This document contains the complete project reference.
...
Instead of fixed courses, you define the vocabulary, translations, conversations, and grammar you want to learn, and Linguatrain drills them using multiple learning modes — including typing, listening, grammar transformations, conjugation practice, conversation simulation, and spoken responses.
...
- YAML-driven language packs — study exactly the content you choose
- Translation mode with chunked, scaffolded learning (`--translation`)
- Vocabulary, grammar, and conversation drills
...
- AI-friendly content authoring workflow
...
Every module is designed around a single learning objective. Rather than teaching an entire language lesson at once, each module exposes one additional layer of linguistic structure.
...
Linguatrain is designed as much for creating language-learning content as it is
for consuming it.
...
Together these provide a complete framework for creating reusable learning
content.
